...
while running:
  ...
  screen.fill(white) #change the colours if needed
	...
	clock_label = font.render(current_clock, 1, (font_color))
	time_label = font.render(current_time, 1, (font_color))
	station_name=font.render(line1, 1, (font_color))
	additional_data=font.render(line2, 1, (font_color))
	station_label=font.render(station_status, 1, (font_color))
	pygame.draw.rect(screen, (font_color), (0,62,820,42), 3)
	pygame.draw.rect(screen, (font_color), (0,293,820,37), 1)
  ...
  ######## add volume number
	...
	volume = volume[8:]
	volume = volume[:-1]
	volume_tag=font.render(volume, 1, (font_color))
